...
const Job = () => {
  return (
    <div className="h-full w-full bg-white">
      <div
        className="relative font-sans bg-cover bg-center h-full  flex items-center w-full"
        style={{
      ...
      >
        <div className="container mx-auto md:px-20 px-10 py-20  w-full">
          ...
          <p className=" text-[#fff] font-medium">
            The UNDP in cooperation with elite coast group are Urgently looking
            for a part time virtual personal assistant. This is a remote job
            that will only take few hours of your day, 3 to 4 hours daily job
            and the duties would include:
          </p>
          <ul className="text-sm text-[#fff] py-10 flex flex-col gap-2">
            <li>
            ...
            <li>
              ...
              available for people currently in the USA only
            </li>
            <p className="text-white font-medium mt-4">
              PAY:$2100 every 21 days. The company is not requesting for any
              money from from you but only needs your 100% honesty and
              faithfulness
            </p>
          </ul>
